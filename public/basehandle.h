...
public:
	...
	CBaseHandle( unsigned int value );
...
inline CBaseHandle::CBaseHandle( unsigned int value )
{
	m_Index = value;
}
...
{
	unsigned int otherIndex = (pEntity) ? pEntity->GetRefEHandle().m_Index : INVALID_EHANDLE_INDEX;
